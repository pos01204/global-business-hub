...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const icons = {
    default: (
      <div className="w-12 h-12 mx-auto bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center mb-4">
        <svg className="w-6 h-6 text-[#F78C3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
