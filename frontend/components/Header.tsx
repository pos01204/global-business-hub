        ...
        <div className="flex items-center gap-2 ml-6">
          ...
          <div className="relative" ref={userMenuRef}>
            <button
              ...
              className="flex items-center gap-2.5 pl-3 pr-2 py-1.5 hover:bg-slate-50 rounded-full border border-slate-200 transition-all hover:border-slate-300 hover:shadow-sm"
            >
              {session?.user?.image ? (
                <Image
            ...
            {/* 사용자 드롭다운 메뉴 */}
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden z-50 animate-slideDown">
                {/* 프로필 헤더 */}
                <div className="px-4 py-4 bg-gradient-to-br from-slate-50 to-slate-100/50">
                ...
                <div className="p-2">
                  <button
                    className="flex items-center justify-center gap-2 w-full px-4 py-2.5 text-sm font-medium text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all"
                    onClick={() => {
                      setShowUserMenu(false)
