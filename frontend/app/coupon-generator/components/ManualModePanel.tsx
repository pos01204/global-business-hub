...
const TEMPLATES = {
  ...
  dormantUser: {
    name: '😴 휴면 고객 복귀',
    description: '휴면 고객 재활성화 쿠폰',
    defaults: {
      couponName: 'お帰りなさい！特別クーポン',
      description: '휴면 고객 복귀 COUPON',
      discountType: 'FIXED' as const,
      discount: 1000,
      currencyCode: 'JPY' as const,
      minOrderPrice: 0,
      maxDiscountPrice: 1000,
      isPublic: false,
      issueUserId: -1, // 특정 사용자 지정 필요
      applicableTargets: [],
    },
  },
  vipExclusive: {
    name: '👑 VIP 전용',
    description: 'VIP 고객 전용 특별 쿠폰',
    defaults: {
      couponName: 'VIP限定20%OFF',
      description: 'VIP 전용 COUPON',
      discountType: 'RATE' as const,
      discount: 20,
      currencyCode: 'JPY' as const,
      minOrderPrice: 15000,
