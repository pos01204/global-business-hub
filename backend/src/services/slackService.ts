          ...
          elements: [
            {
              ...
              url: `${this.hubBaseUrl}/lookup?query=${order.order_code || order.id}&type=order`,
          ...
          elements: [
            {
              ...
              url: `${this.hubBaseUrl}/lookup?query=${customer.user_id || customer.id}&type=user`,
        ...
        elements: [
          {
            ...
            url: `${this.hubBaseUrl}/lookup?query=${encodeURIComponent(artist.name || artist.artist_name)}&type=artist`,
          ...
          elements: [
            {
              ...
              url: `${this.hubBaseUrl}/lookup?query=${encodeURIComponent(query)}`,
